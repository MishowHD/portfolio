...
A concrete example: in **kernel 6.12+**, nft introduced a **bitmask in NAT rules** that allows attaching metadata to packets flowing through chains. Tailscale uses this to tag its own packets — so it can distinguish traffic generated by Tailscale from external traffic for proper routing.
